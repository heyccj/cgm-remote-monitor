...
function init() {
  ...
  var dir2Char = {
    NONE: '⇼'
    , DoubleUp: '<i class="fas fa-angle-double-up"></i>'
    , SingleUp: '<i class="fas fa-chevron-up"></i>'
    , FortyFiveUp: '<i class="fas fa-angle-right slant-up"></i>'
    , Flat: '<i class="fas fa-angle-right"></i>'
    , FortyFiveDown: '<i class="fas fa-angle-right slant-down"></i>'
    , SingleDown: '<i class="fas fa-chevron-down"></i>'
    , DoubleDown: '<i class="fas fa-angle-double-down"></i>'
    //, DoubleUp: '⇈'
    //, SingleUp: '↑'
    //, FortyFiveUp: '↗'
    //, Flat: '→'
